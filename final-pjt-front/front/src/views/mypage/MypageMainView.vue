<template>
  <div v-if="User" style="height: 780px">
    <v-container>
    <v-row>
      <!-- Avatar Column -->
      <v-col cols="3" md="3">
        ...
        <v-col cols="9" md="9">
          <p style="font-size: 20px">
            안녕하세요
            <span style="font-weight: 600; color: #1e88e5"
              >{{ User.username }}님!</span
            >
          </p>
          <p style="font-size: 15px; font-weight: 400; color: #959595">
            재정 보충이 필요한 상태입니다 :)
          </p>
        </v-col>
      </v-row>
  ...
  <v-container style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
      ...
      <v-row>
        <v-col cols="12" md="6">
          <v-card variant="flat" style="background-color: #f6f7f9">
            ...
            <v-card-text>
              <v-list-item>
                <v-list-item-content style="font-size: 16px"
                  >이름 :
                </v-list-item-content>
                <v-list-item-content style="color: #959595">{{
                  User.username
                }}</v-list-item-content>
              </v-list-item>
              <v-list-item>
              ...
              <v-list-item>
                ...
                <v-list-item-content style="color: #959595">{{
                  User.financial_products.slice(1, -1)
                }}</v-list-item-content>
              </v-list-item>
              <v-list-item>
                <v-list-item-content style="font-size: 16px"
                ...
                <v-list-item-content style="color: #959595">
                  {{ User.money }} 만원</v-list-item-content
                >
              </v-list-item>
            </v-card-text>
          </v-card>
    ...
    <p style="font-size: 20px; font-weight: 600; margin: 10px">
      필요한 기능을 모아봤어요!
    </p>
  ...
  "
      ...
      <v-btn
        ...
        variant="text"
        height="50"
        @click="gonav('mypageendmembership')"
        >탈퇴하기</v-btn
      >
    </v-card>
  </div>
